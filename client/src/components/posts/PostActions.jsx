...
const PostActions = ({ postId, user }) => {
  ...
  useEffect(() => {
    const fetchActionData = async () => {
      ...
      try {
        // TODO: Implement /posts/{id}/like-count endpoint in backend
        /*
        ...
        */
        ...
        // TODO: Implement /comments/{postId}/all endpoint in backend
        /*
        ...
        */
        ...
        if (error.response?.status === 400) {
          console.error(
            "Bad request: Check required parameters (e.g., userId)"
          );
        }
      }
    };
