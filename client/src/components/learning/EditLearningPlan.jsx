        ...
        >
          ...
          <div>
            ...
            <select
              value={plan.isPublic}
              onChange={(e) =>
                setPlan({ ...newPlan, isPublic: e.target.value === "true" })
              }
          ...
          <div className="flex space-x-4">
            <button
              type="submit"
              className="flex-1 bg-amber-500 text-white p-3 rounded-md hover:bg-amber-600 transition-colors font-medium"
            >
              Update Plan
            </button>
            <button
              type="button"
              onClick={() => navigate("/learning-plans")}
              className="flex-1 bg-gray-300 text-gray-800 p-3 rounded-md hover:bg-gray-400 transition-colors font-medium"
            >
              Cancel
            </button>
          </div>
